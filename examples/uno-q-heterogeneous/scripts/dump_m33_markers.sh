...
markers=(
  ...
  HIBANA_M33_PARSED_FRAMES
  HIBANA_M33_TX_FRAMES
  HIBANA_M33_LAST_RX
  HIBANA_M33_LAST_RX_PAYLOAD01
  HIBANA_M33_LAST_TX
  HIBANA_M33_OPEN_SESSION
  HIBANA_M33_OPEN_PORT
  HIBANA_M33_REJECT_REASON
  HIBANA_M33_REJECT_EXPECT_SESSION
  HIBANA_M33_REJECT_FRAME_SESSION
  HIBANA_M33_REJECT_META
  HIBANA_M33_TRANSPORT_DEADLINE
  HIBANA_M33_TRANSPORT_DEADLINE_TICKS
)
